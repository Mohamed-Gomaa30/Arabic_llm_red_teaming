...
def evaluate(*arglist):
    ...
    # model = AutoModelForCausalLM.from_pretrained("UBC-NLP/NileChat-3B",trust_remote_code=True ,token="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")
    # tokenizer = AutoTokenizer.from_pretrained("UBC-NLP/NileChat-3B",token="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")
    # print(model)
